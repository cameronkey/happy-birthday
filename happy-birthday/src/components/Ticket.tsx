...
const Ticket: React.FC<TicketProps> = ({ downloadGift, onReturn }) => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen relative px-4 py-8">
      <button 
        onClick={onReturn}
        className="absolute top-4 left-4 md:top-8 md:left-8 bg-white/20 text-white font-bold py-2 px-4 rounded-full shadow-lg hover:bg-white/30 transform transition-all duration-300 flex items-center gap-2 z-20"
      >
