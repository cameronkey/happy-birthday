    ...
    <div className="flex items-center justify-center min-h-screen relative">
      ...
      <div className="relative w-80 sm:w-[22rem] md:w-[24rem] h-[36rem] sm:h-[40rem] md:h-[44rem] bg-gradient-to-br from-yellow-300 to-amber-500 rounded-2xl shadow-2xl overflow-hidden p-6 sm:p-8 flex flex-col items-center justify-between animate-[ticket-appear_1.5s_ease-out] mx-4">
        ...
        <div className="text-center z-10">
          <h3 className="text-amber-800 text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-widest drop-shadow-lg">BIRTHDAY PASS</h3>
        ...
        <div className="text-center z-10">
          <div className="relative">
            <Gift className="w-16 sm:w-20 md:w-24 h-16 sm:h-20 md:h-24 text-amber-800 mx-auto animate-pulse drop-shadow-lg" />
            <div className="absolute inset-0 bg-amber-300/30 rounded-full animate-ping"></div>
          </div>
          <p className="mt-4 text-base sm:text-lg text-amber-900 font-bold">
            This ticket is your key to a special surprise. Click below to unwrap it!
          </p>
        </div>
        ...
        <button 
          ...
          className="mt-8 bg-gradient-to-br from-pink-500 to-orange-500 text-white font-bold py-3 sm:py-4 px-6 sm:px-8 rounded-full shadow-lg hover:scale-105 hover:shadow-2xl transform transition-all duration-300 flex items-center gap-2 focus:outline-none focus:ring-4 focus:ring-pink-300 disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base border-2 border-white/30"
          tabIndex={0}
          aria-label="Download birthday surprise"
        >
          {isDownloading ? (
            <>
              <div className="w-5 h-5 sm:w-6 sm:h-6 border-2 border-white border-t-transparent rounded-full animate-spin drop-shadow"></div>
              Preparing...
            </>
          ) : (
            <>
